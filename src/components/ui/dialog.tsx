      ...
      >
        {showCloseButton && (
          <DialogPrimitive.Close data-slot="dialog-close" asChild>
            <Button
              variant="ghost"
              className="text-hw-muted hover:text-hw-title hover:bg-hw-accent/10 self-end -mt-1 -mr-1 shrink-0"
              size="icon-sm"
            >
              <XIcon />
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-2 rounded-b-xl border-t border-hw-divider bg-hw-input/50 p-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-heading text-base leading-none font-semibold text-hw-title",
        className
      )}
      {...props}
    />
