...
/** Definición de un campo en el formulario de creación/edición */
...
/** Configuración completa de una entidad administrable */
...
export const entityConfigs: EntityConfig[] = [
  ...
  
  {
    ...
    fields: [
      ...
      { name: 'ranurasExpansion',     label: 'Ranuras de Expansión',    type: 'number', required: true },
