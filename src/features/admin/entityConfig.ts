// Configuración declarativa de todas las entidades del panel de administración
...
/** DefiniciÃ³n de un campo en el formulario de creaciÃ³n/ediciÃ³n */
...
/** ConfiguraciÃ³n completa de una entidad administrable */
...
const REFRIGERACION_TIPO_OPTIONS = [
  { value: 'REFRIGERACION_TIPO_LIQUIDA', label: 'LÃ­quida' },
...
export const entityConfigs: EntityConfig[] = [
  ...
  
  {
    ...
    columns: [
      ...
      { key: 'imagen',       header: 'Imagen (public_id)' },
    ...
    fields: [
      ...
      { name: 'imagen',             label: 'Imagen (public_id)',        type: 'text' },
      ...
      { name: 'cacheApilada',       label: 'CachÃ© Apilada',             type: 'boolean' },
      { name: 'arquitectura',       label: 'Arquitectura',              type: 'select',  required: true, options: CPU_ARQ_OPTIONS },
      { name: 'precio',             label: 'Precio (â‚¬)',                type: 'number',  required: true },
      { name: 'hilos',              label: 'Hilos',                     type: 'number',  required: true },
      { name: 'hyperthreading',     label: 'Hyperthreading',            type: 'boolean' },
      { name: 'frecuenciaMax',      label: 'Frecuencia MÃ¡x (GHz)',      type: 'number',  required: true },
      { name: 'frecuenciaMin',      label: 'Frecuencia MÃ­n (GHz)',      type: 'number',  required: true },
      { name: 'cantidadCache',      label: 'CachÃ© (MB)',                type: 'number',  required: true },
      { name: 'tdp',                label: 'TDP (W)',                   type: 'number',  required: true },
      { name: 'temperaturaMax',     label: 'Temperatura MÃ¡x (Â°C)',      type: 'number',  required: true },
      { name: 'conectividadPcie',   label: 'PCIe VersiÃ³n',              type: 'number',  required: true },
  ...
  
  {
    ...
    fields: [
      ...
      { name: 'nucleos',            label: 'NÃºcleos (JSON)',           type: 'json',   required: true },
      { name: 'frecuenciaMax',      label: 'Frecuencia MÃ¡x (GHz)',    type: 'number', required: true },
      { name: 'frecuenciaMin',      label: 'Frecuencia MÃ­n (GHz)',    type: 'number', required: true },
      { name: 'temperaturaMax',     label: 'Temperatura MÃ¡x (Â°C)',    type: 'number', required: true },
  ...
  
  {
    ...
    fields: [
      ...
      { name: 'modulos',           label: 'MÃ³dulos',              type: 'number', required: true },
      { name: 'capacidadPorModulo', label: 'Capacidad/MÃ³dulo (GB)', type: 'number', required: true },
  ...
  
  {
    ...
    columns: [
      ...
      { key: 'certificacion', header: 'CertificaciÃ³n' },
    ],
    fields: [
      { name: 'modelo',        label: 'Modelo',           type: 'text',    required: true },
      { name: 'fabricanteId',  label: 'Fabricante ID',    type: 'number',  required: true },
      ...
      { name: 'certificacion', label: 'CertificaciÃ³n',    type: 'select',  required: true, options: PSU_CERT_OPTIONS },
  ...
  
  {
    ...
    fields: [
      ...
      { name: 'longitudMaxGpu',       label: 'Longitud MÃ¡x GPU (mm)',     type: 'number',  required: true },
      { name: 'bahias25',             label: 'BahÃ­as 2.5"',              type: 'number',  required: true },
      { name: 'bahias35',             label: 'BahÃ­as 3.5"',              type: 'number',  required: true },
      ...
      { name: 'alturaMaxEnfriadorCpu', label: 'Altura MÃ¡x Enfriador (mm)', type: 'number', required: true },
    ],
  },
  ...
  
  {
    ...
    fields: [
      ...
      { name: 'memoriaMaxima',        label: 'Memoria MÃ¡xima (GB)',      type: 'number', required: true },
      ...
      { name: 'ranurasExpansion',     label: 'Ranuras ExpansiÃ³n',       type: 'number', required: true },
  ...
  
  {
    ...
    fields: [
      ...
      { name: 'contrasena', label: 'ContraseÃ±a',  type: 'text',   required: true },
  ...
  
  {
    ...
    columns: [
      ...
      { key: 'refrigeracionId',   header: 'RefrigeraciÃ³n ID' },
  ...
  
  {
    ...
    columns: [
      ...
      { key: 'fecha',           header: 'Fecha' },
      { key: 'usuarioId',       header: 'Usuario ID' },
      { key: 'publicacionId',   header: 'PublicaciÃ³n ID' },
    ],
  },
];
